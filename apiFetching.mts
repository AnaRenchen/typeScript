// To parse this data:
//
//   import { Convert, GitHubRepositoriesType } from "./file";
//
//   const gitHubRepositoriesType = Convert.toGitHubRepositoriesType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

// acá usé https://app.quicktype.io/ para generar los tipos. Es recomendable usar TSZod: TypeScript con Zod: Si necesitas una validación de datos más robusta, tipos personalizados y una mayor seguridad en tu aplicación, TypeScript con Zod es la mejor opción.
export type GitHubRepositoriesType = {
  total_count: number;
...
export class Convert {
  public static toGitHubRepositoriesType(json: string): GitHubRepositoriesType {
    return cast(JSON.parse(json), r("GitHubRepositoriesType"));
  }

  public static gitHubRepositoriesTypeToJson(
    value: GitHubRepositoriesType
  ): string {
    return JSON.stringify(uncast(value, r("GitHubRepositoriesType")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  DefaultBranch: ["dev", "develop", "main", "master"],
...
const data = (await response.json()) as GitHubRepositoriesType;
